...
if (document.URL.includes("/Team/Member")) {
    ...
    //console.log("Min" + inputTkMin.value);
    //console.log("Max" + inputTkMax.value);

    let isLeftThumb = false;
    let isRightThumb = false;
    let thumbposLeft = parseInt(map(inputTkMin.value, 0, 50000, 0, 100));
    let thumbposRight = parseInt(map(inputTkMax.value, 0, 50000, 0, 100));

    //console.log("thumbposLeft" + thumbposLeft)
    //console.log("thumbposRight" + thumbposRight)
